    ...
    fun AttachmentsSection(
        ...
        /*val handleCameraAction = { action: () -> Unit ->
            if (ActivityCompat.checkSelfPermission(context, Manifest.permission.CAMERA) == android.content.pm.PackageManager.PERMISSION_GRANTED) {
                ...
                // Si no hay permiso, lo pide
                cameraPermissionLauncher.launch(Manifest.permission.CAMERA)
                // *Nota: Aquí hay una limitación. No podemos saber cuál de las dos acciones (foto/video)
                // ejecutar después de que se conceda el permiso, ya que solo tienes un `cameraPermissionLauncher`.
                // Para simplificar, asumiremos que si presiona CÁMARA, lanza la acción de foto, y si presiona
                // VIDEO (que añadiremos), lanza la acción de video.

                // Mejor aún, crearemos dos launchers si necesitamos dos acciones separadas después del permiso,
                // pero para seguir con tu estructura de un solo launcher de permisos de cámara,
                // vamos a modificar la lógica de los botones para ser más directa.
            }
        }*/
